...
Options:
  ...
  --no-sys-path               Disable search filters in python's `sys.path`
                              (I tried to remove current working directory either way) that is
