...
* [**Prism.js**](https://github.com/PrismJS/prism) and [**github-markdown-css**](https://github.com/sindresorhus/github-markdown-css) (integrated): used for default to PDF conversion (but with borrowing from [Default_args](https://github.com/kiwi0fruit/pandoctools/blob/master/pandoctools/sh/Default_args) and [Default.html](https://github.com/kiwi0fruit/pandoctools/blob/master/pandoctools/sh/Default.html) to custom profile you can use them with to HTML conversion too).
